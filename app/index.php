...
<div class="main">
    <?php include './php/include/popup.php' ?>
    <!--	Выбор запчасти, каталог -->
    <?php include './php/include/sidebar.php'?>
    <!--	Карточки товара  -->
    <div class="cards" >

        <?php if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['search-field'])): ?>
        <?php include './php/include/searchCards.php'?>
        <?php  elseif($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['category'])): ?>
        <?php include './php/include/category.php'?>
        <?php elseif($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['search-btn'])): ?>
		<?php include './searchAvailable.php'?>	
        <?php else: ?>
        <?php include './php/include/cards.php'?>
        <? endif ;?>
    </div>
</div>
<!-- Раздел о Компании -->
